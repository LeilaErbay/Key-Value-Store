...
#define __TEST_MAX_KEY__ 256		//number keys tested per pod
#define __TEST_MAX_KEY_SIZE__ 31		//size of key
#define __TEST_MAX_DATA_LENGTH__ 256	//size of value
#define __TEST_MAX_POD_ENTRY__ 256		//test number of values per key
#define __TEST_SHARED_MEM_NAME__ "/lerbay1996_store" 
#define __TEST_SHARED_SEM_NAME__ "/ONLY_TEARS_LEILA"		//sem for test2
